...
3. Place the resistor into a free space on the breadboard, and connect it to
   another free space above or below the lamp stand.
...
6. Connect a wire to each leg of the LED in the lamp bulb. Remember the color
   of the cables that connects to the short leg of the LED.

   .. figure:: images/IMG_2583.jpg
      :width: 80%
      :align: center

7. Attach one LED wire to each side of the lamp stand.
